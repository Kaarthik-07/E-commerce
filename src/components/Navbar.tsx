        ...
        <div className='flex items-center justify-between py-4 relative'>
            <div className='flex items-center md:space-x-10 lg:space-x-20'>
                ...
                <nav className='max-md:hidden'>
                    <ul className='flex items-center lg:space-x-10 space-x-7 opacity-70 text-[15px]'>
                        ...
                        {session?.user && (
                        <li><a href="ProductForm" className='py-3 inline-block w-full'>My Products</a></li>
                        )}
                    </ul>
                </nav>
            </div>
            <div className='flex items-center space-x-10'>
                ...
                <div onClick={() => setShowProfile(!showProfile)} className='relative cursor-pointer'>
                    <img src="user.jpeg" className='w-[55px] h-[45px] space-x-17  rounded-full object-cover' alt="" />
                ...
                {session?.user ? (
                    <Link href='/cart'>
                        <div className='p-2 space-x-11 bg-gray-100 rounded-full'><CiShoppingCart size={20} /></div>
                    </Link>
                    ) : (
                    <Link href='/signin'>
